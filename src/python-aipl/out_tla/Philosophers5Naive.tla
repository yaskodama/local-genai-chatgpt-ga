...
Init ==
  ...
  /\ mailboxes = ("p0" :> <<[meth |-> "init", sender |-> "__main__", args |-> <<"f0", "f1", 1>>]>> @@ "p1" :> <<[meth |-> "init", sender |-> "__main__", args |-> <<"f1", "f2", 1>>]>> @@ "p2" :> <<[meth |-> "init", sender |-> "__main__", args |-> <<"f2", "f3", 1>>]>> @@ "p3" :> <<[meth |-> "init", sender |-> "__main__", args |-> <<"f3", "f4", 1>>]>> @@ "p4" :> <<[meth |-> "init", sender |-> "__main__", args |-> <<"f4", "f0", 1>>]>>) @@ [a \in Actors |-> <<>>]
