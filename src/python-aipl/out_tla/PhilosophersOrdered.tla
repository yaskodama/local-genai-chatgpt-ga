...
Init ==
  ...
  /\ mailboxes = ("p0" :> <<[meth |-> "init", sender |-> "__main__", args |-> <<"f0", "f1", 1>>]>> @@ "p1" :> <<[meth |-> "init", sender |-> "__main__", args |-> <<"f1", "f2", 1>>]>> @@ "p2" :> <<[meth |-> "init", sender |-> "__main__", args |-> <<"f0", "f2", 1>>]>>) @@ [a \in Actors |-> <<>>]
